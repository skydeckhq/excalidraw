...
var serializeSelectedAsJSON = (elements, selectedElementIds, appState, files) => {
...
var saveSelectedAsJSON = async (elements, selectedElementIds, appState, files, name = appState.name || DEFAULT_FILENAME) => {
...
var parseFileContents = async (blob) => {
  ...
  if (blob.type === MIME_TYPES5.png) {
    try {
      return await (await import("./data/image-3BYMMUYO.js")).decodePngMetadata(blob);
    } catch (error) {
...
//# sourceMappingURL=chunk-MKM4KCF5.js.map
