...
var labels = {
  ...
  addWatermark: 'Add "Made with Skydeck"',
  ...
  name: "Name",
  yourName: "Your name",
  madeWithSkydeck: "Made with Skydeck",
  ...
  installPWA: "Install Skydeck locally (PWA)",
...
var buttons = {
  ...
  saveAs: "Save as",
  saveSelectedAsJSON: "Save selected as JSON",
  load: "Open",
...
var alerts = {
  ...
  uploadedSecurly: "The upload has been secured with end-to-end encryption, which means that Skydeck server and third parties can't read the content.",
  ...
  invalidSceneUrl: "Couldn't import scene from the supplied URL. It's either malformed, or doesn't contain valid Skydeck JSON data.",
...
var toolBar = {
  ...
  mermaidToSkydeck: "Mermaid to Skydeck",
...
var roomDialog = {
  ...
  shareTitle: "Join a live collaboration session on Skydeck"
};
var errorDialog = {
  title: "Error"
};
var exportDialog = {
  ...
  excalidrawplus_description: "Save the scene to your Skydeck+ workspace.",
  excalidrawplus_button: "Export",
  excalidrawplus_exportError: "Couldn't export to Skydeck+ at this moment..."
};
var helpDialog = {
  blog: "Read our blog",
  click: "click",
...
var encrypted = {
  tooltip: "Your drawings are end-to-end encrypted so Skydeck's servers will never see them.",
  link: "Blog post on end-to-end encryption in Skydeck"
};
var stats = {
  angle: "Angle",
  shapes: "Shapes",
...
var toast = {
  ...
  selectedElementsSaved: "Saved {{count}} selected element(s).",
  canvas: "canvas",
  selection: "selection",
...
var welcomeScreen = {
  app: {
    ...
    center_heading_plus: "Did you want to go to the Skydeck+ instead?",
...
var overwriteConfirm = {
  action: {
    ...
    excalidrawPlus: {
      title: "Skydeck+",
      button: "Export to Skydeck+",
      description: "Save the scene to your Skydeck+ workspace."
    }
  },
  modal: {
    loadFromFile: {
...
var mermaid = {
  title: "Mermaid to Skydeck",
  button: "Insert",
  description: "Currently only <flowchartLink>Flowchart</flowchartLink>,<sequenceLink> Sequence, </sequenceLink> and <classLink>Class </classLink>Diagrams are supported. The other types will be rendered as image in Skydeck.",
...
var chat = {
  ...
  rateLimit: {
    messageLimit: "You've hit your AI limit on the free plan. Try out Skydeck+ for more or come back tomorrow.",
...
//# sourceMappingURL=chunk-QSONVX4A.js.map
